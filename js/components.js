                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <span class="color_14" style=" font-size:16px; font-family:open sans,sans-serif;">
                            ${bro1}</span>
                            </h2>
                            <figure class="about-img animate" data-animate="fadeInUp"><img
...
class Brothers34 extends HTMLElement {
    constructor() {
        super();
    }
    ...
    connectedCallback() {
        ...
        var src5 = this.attributes.src5.value
        var src6 = this.attributes.src6.value
        var src7 = this.attributes.src7.value
        ...
        var bro5 = this.attributes.bro5.value
        var bro6 = this.attributes.bro6.value
        var bro7 = this.attributes.bro7.value
    ...
    <h2 class="font_2"
        ...
        <figure class="about-img animate" data-animate="fadeInUp"><img
            src=${src7} class="rounded" alt="" loading="lazy">
        </figure>
    </div>
</div>
                </div>
...
customElements.define('bros-component34', Brothers34);